...
final class UserControllerTest extends TestCase
{
    ...
    {
        return route('api.v2.admin.users.list', $params);
    }
    ...
    {
        $url = route('api.v2.admin.users.delete', random_int(1, 99999));
    ...
    public function test_user_is_deleted_when_good_id_is_passed()
    {
        ...
        $url = route('api.v2.admin.users.delete', $id);
    ...
    {
        $url = route('api.v2.admin.users.delete', 0);
    ...
    {
        $this->callAdminUsersEndpoint([], 'api.v2.admin.users.list')
