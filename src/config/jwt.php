...
return [
    ...
    |
    */
    //@todo remove default in CXP-2014
    'secret' => env('JWT_SECRET', 'LlfLrEG4pK2eAcc+V4wvTx0g6tXVnN7FKDEPJ8MB+8A='),
    ...
    */
    ...
    'algo' => env('MAGIC_JWT_ALGO', Tymon\JWTAuth\Providers\JWT\Provider::ALGO_HS256),
