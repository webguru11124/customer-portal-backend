...
return [
    'management' => [
        ...
        'audience' => \Auth0\Laravel\Configuration::stringToArrayOrNull(env('AUTH0_API_AUDIENCE')),
        'domain' => env('AUTH0_API_DOMAIN'),
        'timeout' => env('AUTH0_API_TIMEOUT', \App\Providers\Auth0\UserServiceProvider::REQUEST_TIMEOUT),
    ],
    ...
    'cookieExpires' => (int) env('COOKIE_EXPIRES', 0),
