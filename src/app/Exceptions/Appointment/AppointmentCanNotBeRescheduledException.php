...
class AppointmentCanNotBeRescheduledException extends AbstractHttpException
{
    ...
    public function __construct(
        ...
        $this->message = !empty($message) ? $message : __('exceptions.cant_reschedule_appointment');
    }
}
